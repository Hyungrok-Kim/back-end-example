		...
		<form id="updateForm" action="/myWeb/mUpdate.me" method="post">
			...
			<table align="center">
				<tr>
					...
					<td style="color:white; text-align: left; padding-left: 20px;">${m.userId}</td>
					<td width="200px"></td>
				</tr>
				<tr>
					<td>* 변경 비번</td>
				...
				<tr>
					<td>* 이름</td>
					<td style="color:white; text-align: left; padding-left: 20px;">${m.userName}</td>
					<td></td>
				</tr>
				<tr>
					<td>성별 </td>
				...
				<tr>
					<td>나이 </td>
					<td><input type="number" name="age" min="10" max="100" value="${m.age }"
					      style="width:140px;">&nbsp;세
					</td>
					<td></td>
				</tr>
			...
			<script>
				...
				function deleteMember() {
					location.href = "/myWeb/mDelete.me?mid=${m.userId}";
				}
